...
// check if part is in this.parts
// replace if type is matching
// return difference: computer.value - newComputer.value
// else
// add if dissimilar to any part in this.parts
  ...
  it('should not be able to fly without parts', function() {
    ...
    fighter.fuel = 1000;
    var status = fighter.checkReadiness();
// console.log(fighter.parts)
// console.log(Object.keys(fighter.parts).length)
// console.log(fighter.parts === {})
    assert.isFalse(fighter.readyToFly);
  ...
  it('should be able to fly if it has fuel, a captain and parts', function() {
    ...
    fighter.fuel = 1000;
    var status = fighter.checkReadiness();
// console.log(fighter.captain)
// console.log(fighter.fuel)
// console.log(fighter.parts)
// console.log(status)
// console.log(fighter.parts)
// console.log(Object.keys(fighter.parts).length)
